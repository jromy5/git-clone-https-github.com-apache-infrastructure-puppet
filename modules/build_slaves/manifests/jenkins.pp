...
class build_slaves::jenkins (
  ...
  $java_asfpackages = [jdk1.5.-_22-32', 'jdk1.5.0_22-64','jdk1.6.0_45-64', 'jdk1.7.0-64', 'jdk1.7.0_79-unlimited-security', 'jdk1.7.0_80', 'jdk1.8.0_66-unlimited-security', 'jdk1.8.0_92', 'jdk1.8.0_102', 'jdk-9-ea-b128', 'jdk-9-ea-b132', 'jdk-9-ea-b139', 'ibm-java-x86_64-80'],
) {
