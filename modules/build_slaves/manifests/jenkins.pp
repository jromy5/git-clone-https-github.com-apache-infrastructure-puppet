...
class build_slaves::jenkins (
  ...
  $java_jenkins = ['ibm-1.4-32', 'ibm-1.4-64', 'ibm-1.5-32', 'ibm-1.5-64', 'ibm-1.6-32', 'ibm-1.6-64', 'harmony-1.5-64', 'jdk1.5.0_17-32','jdk1.5.0_17-64','jdk1.6.0_11-32','jdk1.6.0_11-64','jdk1.6.0_20-32','jdk1.6.0_20-32-unlimited-security','jdk1.6.0_20-64','jdk1.6.0_27-32','jdk1.6.0_27-64','jdk1.6.0_45-32','jdk1.7.0_04','jdk1.7.0_55', 'jdk1.8.0'],
  $java_asfpackages = ['jdk1.5.0_22-32', 'jdk1.5.0_22-64','jdk1.6.0_45-64', 'jdk1.7.0-32', 'jdk1.7.0-64', 'jdk1.7.0_25-32', 'jdk1.7.0_25-64', 'jdk1.7.0_79-unlimited-security', 'jdk1.7.0_80', 'jdk1.8.0_66-unlimited-security', 'jdk1.8.0_92', 'jdk1.8.0_102', 'jdk-9-ea-b128', 'jdk-9-ea-b132', 'jdk-9-ea-b139', 'ibm-java-x86_64-60', 'ibm-java-x86_64-80'],
) {
