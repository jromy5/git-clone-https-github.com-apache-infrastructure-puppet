...
################### create symlinks #############################
  ...
  exec { 'create symlink for JDK1.8':
    ...
    onlyif   => "if ((get-item F:\\jenkins\\tools\\java).lastwritetime -eq (get-item latest1.8).lastwritetime) { exit 1;}  else { exit 0; }",# lint:ignore:140chars
    provider => powershell,
  }
  exec { 'create symlink for JDK1.7':
    ...
    onlyif   => "if ((get-item F:\\jenkins\\tools\\java).lastwritetime -eq (get-item latest1.7).lastwritetime) { exit 1;}  else { exit 0; }",# lint:ignore:140chars
    provider => powershell,
  }
  exec { 'create symlink for JDK1.6':
    ...
    onlyif   => "if ((get-item F:\\jenkins\\tools\\java).lastwritetime -eq (get-item latest1.6).lastwritetime) { exit 1;}  else { exit 0; }",# lint:ignore:140chars
    provider => powershell,
  }
  exec { 'create symlink for JDK1.5':
    ...
    onlyif   => "if ((get-item F:\\jenkins\\tools\\java).lastwritetime -eq (get-item latest1.5).lastwritetime) { exit 1;}  else { exit 0; }",# lint:ignore:140chars
    provider => powershell,
  }
