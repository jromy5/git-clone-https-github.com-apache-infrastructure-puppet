...
class buildbot_slave::buildbot (
  ...
  $java_asfpackages = ['harmony-jdk-713673' , 'jdk1.5.0_22-64', 'jdk1.6.0_45-64', 'jdk1.7.0_79-unlimited-security', 'jdk1.7.0_80', 'jdk1.8.0_66-unlimited-security', 'jdk1.8.0_92', 'jdk1.8.0_102', 'jdk1.8.0_121', 'jdk1.8.0_144', 'jdk1.8.0_144-unlimited-security', 'jdk1.8.0_152' , 'jdk-9-ea-b132', 'jdk-9-ea-b139', 'jigsaw-jdk-9-ea-b156', 'jdk-9-ea-b179' , 'jdk-9-b181' , 'jdk-9-b181-unlimited-security' , 'IBMJava2-142' , 'IBMJava2-amd64-142' , 'ibm-java2-i386-50' , ' ibm-java-i386-60' , 'ibm-java2-x86_64-50' , 'ibm-java-x86_64-80' , 'jdk9.0.1'], # lint:ignore:140chars
