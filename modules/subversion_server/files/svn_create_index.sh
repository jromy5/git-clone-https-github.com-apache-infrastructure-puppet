...
function create_gnu_index ()
{
    ...
    (
        ...
        echo "<h1>Please note: Most people will not need to use these files</h1>"
        echo "<h1>Dumps of the ASF Subversion repository</h1>"
...
create_gnu_index "/x1/svn/dump//" "/" "svn-dump.apache.org"
