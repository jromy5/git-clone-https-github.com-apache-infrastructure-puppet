...
public class NotificationRecipient
{
     ...
     */
    public NotificationRecipient(final User user)
    {
    ...
    {
        return ComponentAccessor.getUserPreferencesManager().getPreferences(user).getString(PreferenceKeys.USER_NOTIFICATIONS_MIMETYPE);
    }
