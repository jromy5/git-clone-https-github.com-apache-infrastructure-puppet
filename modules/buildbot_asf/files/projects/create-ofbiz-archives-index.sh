...
<ul> 
        	...
        	<h3>Archived 11.04 Builds</h3> 
		<ul>' >> index.html

find . -name "*rel11.04*.zip" -exec echo '<li><a href={} title={}>{} </a></li>' \; | sort -r | sed -e s/\\.\\///g >> index.html

echo '</ul>
<ul> 
			<li><a href='/projects/ofbiz/snapshots' title='Download current 11.04 snapshots'>Download current 11.04 snapshots</a></li> 
		</ul> 

        	<h3>Archived 10.04 Builds (Discontinued)</h3> 
		<ul>' >> index.html

find . -name "*rel10.04*.zip" -exec echo '<li><a href={} title={}>{} </a></li>' \; | sort -r | sed -e s/\\.\\///g >> index.html

echo '</ul>
<ul> 
			<li><a href='/projects/ofbiz/snapshots' title='Download current 10.04 snapshots'>Download current 10.04 snapshots</a></li> 
		</ul> 

		<h3>Archived 9.04 Builds (Discontinued)</h3> 
		<ul>' >> index.html

find . -name "*rel9.04*.zip" -exec echo '<li><a href={} title={}>{} </a></li>' \; | sort -r | sed -e s/\\.\\///g >> index.html

echo '</ul>
<ul> 
			<li><a href='/projects/ofbiz/snapshots' title='Download current 9.04 snapshots'>Download current 9.04 snapshots</a></li> 
		</ul> 
		<h3>Archived 4.0 Builds (Discontinued)</h3> 
		<ul>' >> index.html

find . -name "*rel4.0*.zip" -exec echo '<li><a href={} title={}>{} </a></li>' \; | sort -r | sed -e s/\\.\\///g >> index.html
