...
class bb_pip_asf (
  ...
  file { 
    "$venv_dir/.profile":
      ...
      owner   => $username,
      group   => $groupname,
      content => template('bb_pip_asf/profile.erb');
    "$venv_dir/master1/master.cfg":
      ensure  => 'present',
      owner   => $username,
      group   => $groupname,
      notify  => Exec['buildbot-reconfig'],
      content => template('bb_pip_asf/master.cfg.erb');
    "$venv_dir/master1/buildbot.tac":
      ensure  => 'present',
      owner   => $username,
      group   => $groupname,
      content => template('bb_pip_asf/buildbot.tac.erb');
    "$venv_dir/master1/private.py":
      ensure  => 'present',
      owner   => $username,
      group   => $groupname,
      mode    => '0640',
      content => template('bb_pip_asf/private.py.erb');
    ...
    "$venv_dir/master1/templates/root.html":
      ...
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/root.html';
    "$venv_dir/master1/public_html/asf_logo_wide_2016.png":
      ensure => 'present',
      mode   => '0644',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/asf_logo_wide_2016.png';
    "$venv_dir/master1/public_html/bg_gradient.jpg":
      ensure => 'present',
      mode   => '0644',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/bg_gradient.jpg';
    "$venv_dir/master1/public_html/default.css":
      ensure => 'present',
      mode   => '0644',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/default.css';
    "$venv_dir/master1/public_html/favicon.ico":
      ensure => 'present',
      mode   => '0644',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/favicon.ico';
    "$venv_dir/master1/public_html/style.css":
      ensure => 'present',
      mode   => '0644',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/style.css';
    "$venv_dir/master1/public_html/robots.txt":
      ensure => 'present',
      mode   => '0644',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/robots.txt';
    ...
    '/etc/init.d/configscanner':
      ...
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/configscanner.ubuntu';
    "$venv_dir/master1/configscanner.py":
      ensure => 'present',
      mode   => '0755',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/configscanner.py';
    ...
    "$venv_dir/master1/create-master-index.sh":
      ...
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/create-master-index.sh';
    ...
    "$venv_dir/master1/public_html/projects/openoffice/create-ooo-snapshots-index.sh":
      ...
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/create-ooo-snapshots-index.sh';
    "$venv_dir/master1/public_html/projects/xmlgraphics/fop/create-fop-snapshots-index.sh":
      ensure => 'present',
      mode   => '0755',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/projects/create-fop-snapshots-index.sh';
    "$venv_dir/master1/public_html/projects/xmlgraphics/batik/create-batik-snapshots-index.sh":
      ensure => 'present',
      mode   => '0755',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/projects/create-batik-snapshots-index.sh';
    "$venv_dir/master1/public_html/projects/xmlgraphics/commons/create-commons-snapshots-index.sh":
      ensure => 'present',
      mode   => '0755',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/projects/create-commons-snapshots-index.sh';
    "$venv_dir/master1/public_html/projects/subversion/nightlies/create-subversion-nightlies-index.sh":
      ensure => 'present',
      mode   => '0755',
      owner  => $username,
      group  => $groupname,
      source => 'puppet:///modules/bb_pip_asf/projects/create-subversion-nightlies-index.sh';
  }
