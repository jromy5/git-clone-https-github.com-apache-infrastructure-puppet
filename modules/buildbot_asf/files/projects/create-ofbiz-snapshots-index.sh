...
find . -name "*rel11.04*.zip" -exec echo '<li><a href={} title={}>{} </a></li>' \; | sort -r | sed -e s/\\.\\///g >> index.html
                        ...
                        echo '</ul>
                        <ul> 
			        <li><a href='/projects/ofbiz/archive/snapshots' title='Download archives of 11.04 snapshots'>Download archives of 11.04 snapshots</a></li> 
		        </ul>
         	...
         	<h3>Nightly 10.04 Builds (Discontinued)</h3> 
		        <ul><p>No more nightlies supplied</p></ul>
                        ...
                        <ul> 
			        <li><a href='/projects/ofbiz/archive/snapshots' title='Download archives of 10.04 snapshots'>Download archives of 10.04 snapshots</a></li> 
		        </ul>
		...
		<h3>Nightly 9.04 Builds (Discontinued)</h3> 
		        <ul><p>No more nightlies supplied</p></ul>
                        ...
                        <ul>
			        <li><a href='/projects/ofbiz/archive/snapshots' title='Download archives of 9.04 snapshots'>Download archives of 9.04 snapshots</a></li> 
		        </ul> 
                <h3>Nightly 4.0 Builds (Discontinued)</h3> 
		        <ul><p>No more nightlies supplied</p></ul>

                        <ul>
		        	<li><a href='/projects/ofbiz/archive/snapshots' title='Download archives of 4.0 snapshots'>Download archives of 4.0 snapshots</a></li> 
		        </ul> 
	</div> 
	<!-- column 2 -->' >> index.html
