...
var HTML, app, changePage, checkPrivacy, colorField, cuserExists, fetch, formData, formSubmitted, forms, get, isArray, isHash, lastGoodFormData, loadForm, makeWave, mk, post, postJSON, preloadFiles, preloaded, regex, renderForm, saveFile, set, submitForm, txt, urls, userExists, verifiers, verifyCONF, verifyField, verifyJIRA, xobj, xpage,
...
renderForm = function(state, page) {
  var bc, bctext, box, bpct, doc, e, el, entry, fdiv, field, form, hasMandatory, i, idiv, j, key, l, len, len1, list, mpct, options, pages, ref, sel, tdiv, val, wpct, x, xbc;
  doc = xobj;
  doc.innerHTML = "";
...
changePage = function(form, page, norender) {
  var el, entry, field, key, pages, ref, rv;
